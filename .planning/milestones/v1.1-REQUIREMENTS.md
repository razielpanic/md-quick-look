# Requirements Archive: v1.1 Public Release (GitHub)
...
- [ ] **SIGN-01**: Set up Apple Developer account — *deferred to App Store milestone*
- [ ] **SIGN-02**: Configure code signing with hardened runtime — *deferred*
- [ ] **SIGN-03**: Sign Quick Look extension (.appex) — *deferred*
- [ ] **SIGN-04**: Sign host app (.app) — *deferred*
- [ ] **SIGN-05**: Notarize app via xcrun notarytool — *deferred*
- [ ] **SIGN-06**: Staple notarization ticket to app — *deferred*
...
- Shipped: 28 (100% of active requirements)
- Deferred: 6 (SIGN-01 through SIGN-06, by design)

---

## Milestone Summary

**Shipped:** 28 of 34 v1.1 requirements
**Adjusted:** SIGN-01 through SIGN-06 descoped during Phase 9 planning — unsigned release with Gatekeeper bypass instructions instead
**Dropped:** None
