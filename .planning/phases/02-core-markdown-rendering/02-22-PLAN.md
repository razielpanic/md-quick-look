...
Note: The two trailing spaces (`  `) before `\n` create a hard break in CommonMark, forcing a line break instead of a space.
  ...
  <verify>
Build succeeds: `cd /Users/razielpanic/Projects/md-quick-look && xcodebuild -project md-quick-look/md-quick-look.xcodeproj -scheme md-quick-look -configuration Release build 2>&1 | tail -5`
  </verify>
  <done>
