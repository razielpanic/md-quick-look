...
Note: The two trailing spaces (`  `) before `\n` create a hard break in CommonMark, forcing a line break instead of a space.
  ...
  <verify>
Build succeeds: `cd /Users/razielpanic/Projects/md-spotlighter && xcodebuild -project md-spotlighter/md-spotlighter.xcodeproj -scheme md-spotlighter -configuration Release build 2>&1 | tail -5`
  </verify>
  <done>
