...
Build the project:
```bash
cd /Users/razielpanic/Projects/md-quick-look && make build
```
...
```bash
cd /Users/razielpanic/Projects/md-quick-look && make build && make install
```

Then test the preview:
```bash
qlmanage -p /Users/razielpanic/Projects/md-quick-look/samples/comprehensive.md
```
