...
3. Generate 1024x1024 master icon:
   ...
   - Draw octothorpe (#) overlapping/cutting through the star
...
- Layer symbols with `-compose Over -composite`
...
`head -20 scripts/generate-icon.sh` shows shebang and purpose comments.
  ...
  <done>
Shell script exists at scripts/generate-icon.sh with ImageMagick commands for icon generation.
  </done>
</task>
