...
- `NSColor.quaternarySystemFill` in applyInlineCodeAttributes (line 663)
...
Grep confirms changes: `grep -n "labelColor\|linkColor" md-spotlighter/MDQuickLook/MarkdownRenderer.swift`
  </verify>
  <done>
...
These are already semantic colors that adapt correctly.
  ...
  <verify>
Build succeeds: `make build`
Grep confirms: `grep -n "separatorColor" md-spotlighter/MDQuickLook/MarkdownLayoutManager.swift`
  </verify>
  <done>
...
These are already semantic colors that adapt correctly.
  ...
  <verify>
Build succeeds: `make build`
Grep confirms: `grep -n "labelColor" md-spotlighter/MDQuickLook/TableRenderer.swift`
  </verify>
  <done>
