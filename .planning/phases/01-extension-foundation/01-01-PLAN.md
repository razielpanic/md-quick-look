...
must_haves:
  ...
  artifacts:
    - path: "md-quick-look/md-quick-look.xcodeproj/project.pbxproj"
...
1. Create directory structure:
   - md-quick-look/ (project root)
   - md-quick-look/md-quick-look/ (host app target)
   - md-quick-look/MDQuickLook/ (Quick Look extension target)
...
3. Quick Look extension Info.plist (CRITICAL for UTI registration):
   ...
   - CFBundleIdentifier: com.razielpanic.md-quick-look.quicklook
   - NSExtension with:
...
4. Create project.pbxproj:
   - Two targets: md-quick-look (app) and MDQuickLook (extension)
...
Use xcodebuild or swift package commands where possible. For project.pbxproj, generate manually with proper UUIDs.
  ...
  <verify>
    xcodebuild -project md-quick-look/md-quick-look.xcodeproj -list
    Should show both targets: md-quick-look and MDQuickLook
  </verify>
  <done>
...
2. OSLog extension for subsystem "com.razielpanic.md-quick-look" category "quicklook"
...
- Key milestone logging only (loaded, complete)
  ...
  <verify>
    xcodebuild -project md-quick-look/md-quick-look.xcodeproj -scheme MDQuickLook -configuration Debug build
...
<verification>
1. Project structure exists at md-quick-look/
