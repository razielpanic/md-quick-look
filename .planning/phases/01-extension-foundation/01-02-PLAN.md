...
2. Verify installation:
   - ls -la ~/Library/QuickLook/md-spotlighter.app/
   - Check Contents/Library/QuickLook/ contains the extension

3. Run qlmanage -m to list Quick Look generators
   - Look for com.razielpanic.md-spotlighter.quicklook in output
...
If errors occur:
- Check Console.app for sandbox errors: log stream --predicate 'subsystem == "com.razielpanic.md-spotlighter"'
