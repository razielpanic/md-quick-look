...
3. Verify extension is installed to /Applications
  ...
  <verify>
`cd /Users/razielpanic/Projects/md-spotlighter && make install 2>&1 | tail -10` shows successful installation
  </verify>
  <done>
Extension built and installed to /Applications/md-spotlighter.app
  </done>
</task>
...
4. Verify:
   ...
   - [ ] Empty cell in third row shows subtle indicator
...
5. Test edge cases:
   ...
   - Table with many columns (should fit within preview width)
  </how-to-verify>
...
5. User verification confirms visual quality
</verification>
