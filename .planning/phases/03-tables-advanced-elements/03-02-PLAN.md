...
- The fallback approach (placeholder substitution) may be more reliable initially
  ...
  <verify>
Build succeeds: `cd /Users/razielpanic/Projects/md-quick-look && xcodebuild -project md-quick-look/md-quick-look.xcodeproj -scheme md-quick-look -configuration Release build 2>&1 | tail -20`
  </verify>
  <done>
...
3. Verify extension is installed to /Applications
  ...
  <verify>
`cd /Users/razielpanic/Projects/md-quick-look && make install 2>&1 | tail -10` shows successful installation
  </verify>
  <done>
