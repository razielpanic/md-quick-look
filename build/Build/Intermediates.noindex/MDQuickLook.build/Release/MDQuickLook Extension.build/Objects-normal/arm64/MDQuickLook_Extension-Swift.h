...
#ifndef MDQUICKLOOK_EXTENSION_SWIFT_H
#define MDQUICKLOOK_EXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MDQuickLook_Extension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21MDQuickLook_Extension21MarkdownLayoutManager")
...
@class NSURL;
@class NSBundle;
SWIFT_CLASS("_TtC21MDQuickLook_Extension21PreviewViewController")
